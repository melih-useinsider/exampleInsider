...
import 'package:insider_ios/components/CustomButton.dart';
              ...
              child: CustomButton(
                  ...
                  onPressed: () async {
                    ...
                    Map? recommendationWithID =
                        await FlutterInsider.Instance.getSmartRecommendation(
                            1, "tr_TR", "TRY");

                    print(
                        "[INSIDER][getSmartRecommendation]: $recommendationWithID");
                    ...
                    print(
                        "[INSIDER][getSmartRecommendationWithProduct]: $recommendationWithProduct");
                    ...
                    print(
                        "[INSIDER][getSmartRecommendationWithProductIDs]: $recommendationWithProductIDs");
                  }),
            ),
          ],
        ),
