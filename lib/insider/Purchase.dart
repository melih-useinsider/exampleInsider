        ...
        Row(
          ...
          children: <Widget>[
            ...
            SizedBox(
              width: MediaQuery.of(context).size.width * 0.43,
              child: CustomButton(
                  buttonText: 'Item Remove To Cart',
                  onPressed: () {
                    ...
                    print(
                        '[INSIDER][itemRemovedFromCart]: Method is triggered.');
                    print('[INSIDER][itemRemovedFromCart][productID]: ' +
                        productID);
                  }),
            )
          ],
            ...
            SizedBox(
              ...
              child: CustomButton(
                  ...
                  onPressed: () {
                    ...
                    print('[INSIDER][itemPurchased][uniqueSaleID]: ' +
                        uniqueSaleID);
                  }),
            ),
            SizedBox(
