            ...
            SizedBox(
              ...
              child: CustomButton(
                  ...
                  onPressed: () async {
                    ...
                    print(
                        '[INSIDER][getContentStringWithName]: $contentOptimizerString');
                    ...
                    print(
                        '[INSIDER][getContentBoolWithName]: $contentOptimizerBool');
                    ...
                    print(
                        '[INSIDER][getContentIntWithName]: $contentOptimizerInt');
                  }),
            ),
          ],
        ),
